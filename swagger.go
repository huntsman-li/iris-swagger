...
func WrapHandler(h *webdav.Handler) context.Handler {
	...
	return func(c context.Context) {
		...
		case "index.html":
			...
			index.Execute(c.ResponseWriter(), s)
		case "doc.json":
...
func DisablingWrapHandler(h *webdav.Handler, envName string) context.Handler {
